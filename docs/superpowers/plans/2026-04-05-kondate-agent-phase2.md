...
- [ ] **Step 1: schema.tsにpurchasesテーブルを追加**
...
- [ ] **Step 1: kondate-agent.tsにsend_line・parse_receiptツールを追加**
...
- [ ] **Step 2: LINE Developers Consoleで設定**
...
- [ ] **Step 3: LINE DevelopersでWebhook URLを設定**
